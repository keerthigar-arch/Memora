...
/** Same visual language as the customer site footer; links match admin routes only. */
@Component({
  selector: 'app-footer',
  standalone: true,
    ...
    <footer class="footer">
      <div class="container footer-grid">
        <div class="footer-brand">
          <a routerLink="/events" class="footer-logo">
          ...
          <p class="footer-tagline">Manage events, pricing payments, and organizer tools in one place.</p>
        ...
        <div class="footer-section">
          <h4 class="footer-heading">Console</h4>
          <ul class="footer-links">
            ...
            <li><a routerLink="/payments" class="footer-link">Pricing payments</a></li>
        ...
        <div class="footer-section">
          <h4 class="footer-heading">Create &amp; pay</h4>
          <ul class="footer-links">
            <li><a routerLink="/create-event" class="footer-link">New event draft</a></li>
            <li><a routerLink="/create-event/success" class="footer-link">Payment success</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="footer-bottom">
        <div class="container footer-bottom-inner">
          <p>© {{ year }} Memora · Admin portal. All rights reserved.</p>
